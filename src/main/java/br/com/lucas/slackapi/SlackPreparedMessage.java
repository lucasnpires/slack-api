...
public class SlackPreparedMessage {
	...
	private SlackPreparedMessage(String message, boolean unfurl, boolean linkNames, SlackAttachment[] attachments,
			String threadTimestamp, boolean replyBroadcast) {
	...
	public static class Builder {
		...
		public SlackPreparedMessage build() {
			return new SlackPreparedMessage(message, unfurl, linkNames, attachments.toArray(new SlackAttachment[] {}),
					threadTimestamp, replyBroadcast);
		}
	}

	@Override
	public String toString() {
		return "SlackPreparedMessage{" + "message='" + message + '\'' + ", unfurl=" + unfurl + ", attachments="
				+ attachments + '}';
	}
	...
	public boolean equals(Object o) {
		...
		return isUnfurl() == that.isUnfurl() && isLinkNames() == that.isLinkNames()
				&& isReplyBroadcast() == that.isReplyBroadcast() && Objects.equals(getMessage(), that.getMessage())
