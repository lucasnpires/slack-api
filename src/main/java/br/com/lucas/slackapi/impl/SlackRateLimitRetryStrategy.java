...
/**
 * Custom implementation of the {@link ServiceUnavailableRetryStrategy}
 * interface that retries {@code 429} (Too Many Requests) responses for a fixed
 * number of times at a default or the 'Retry-After' header configured interval.
 */
@Contract
public class SlackRateLimitRetryStrategy implements ServiceUnavailableRetryStrategy {
	 ...
	 * our retry code list. Default value is 3.
	 */
